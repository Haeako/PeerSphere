quiz_questions = {
    1: {
        ...
        "scores": {
            "Chúc mừng họ và xem đó là động lực để cố gắng hơn.": 3,
            "So sánh bản thân với họ và cảm thấy áp lực nhưng vẫn cố gắng.": 2,
            "Trách bản thân vì không đủ giỏi và cảm thấy thất vọng.": 1,
            "Nghĩ rằng họ chỉ may mắn và không thực sự giỏi hơn mình.": 0
        }
    },
    2: {
        "id": 2,
        "question": "Bạn bè của bạn đang tham gia nhiều hoạt động ngoại khóa và đạt được nhiều thành tựu. Bạn sẽ phản ứng thế nào?",
        "options": {
        ...
        "scores": {
            "Tôi sẽ cân nhắc tham gia nếu thấy phù hợp với bản thân.": 3,
            "Cảm thấy một chút áp lực nhưng vẫn theo đuổi mục tiêu của mình.": 2,
            "Vội vàng đăng ký nhiều hoạt động để không bị thua kém.": 1,
            "Cảm thấy tự ti và không muốn tham gia bất kỳ hoạt động nào.": 0
        }
    },
    3: {
        "id": 3,
        ...
        "scores": {
            "Hiểu rằng đó chỉ là một phần cuộc sống của họ và không ảnh hưởng đến mình.": 3,
            "Cảm thấy hơi chạnh lòng nhưng không để nó ảnh hưởng đến tâm trạng.": 2,
            "Bắt đầu so sánh cuộc sống của mình với họ và cảm thấy áp lực.": 1,
            "Cố gắng tạo ra một hình ảnh hào nhoáng trên mạng xã hội để không bị tụt lại.": 0
        }
    },
    4: {
        "id": 4,
        ...
        "scores": {
            "Hiểu rằng mỗi người có một con đường riêng và tập trung vào mục tiêu của mình.": 3,
            "Thấy hơi áp lực nhưng vẫn cố gắng phát triển bản thân.": 2,
            "Cảm thấy tổn thương và tự trách bản thân.": 1,
            "Phản ứng tiêu cực, cãi lại hoặc tránh xa gia đình.": 0
        }
    },
    5: {
        "id": 5,
        ...
        "scores": {
            "Tìm hiểu xem có công việc nào phù hợp với mình không.": 3,
            "Học cách quản lý thời gian tốt hơn để có thể vừa học vừa làm.": 2,
            "Cảm thấy áp lực và tìm việc ngay cả khi chưa sẵn sàng.": 1,
            "Nghĩ rằng mình vô dụng vì không có việc làm thêm.": 0
        }
    },
    6: {
        "id": 6,
        ...
        "scores": {
            "Chỉ tham gia nếu không ảnh hưởng đến tài chính cá nhân.": 3,
            "Thỉnh thoảng đi cùng nhưng kiểm soát chi tiêu hợp lý.": 2,
            "Cố gắng chạy theo để không bị lạc lõng.": 1,
            "Vay tiền hoặc tiêu quá mức để theo kịp họ.": 0
        }
    },
    7: {
        "id": 7,
        ...
        "scores": {
            "Học hỏi từ họ nhưng vẫn giữ vững con đường riêng của mình.": 3,
            "Cảm thấy áp lực nhưng vẫn cố gắng theo đuổi điều mình thích.": 2,
            "Thay đổi hoàn toàn để giống họ, dù không thực sự thích.": 1,
            "Cắt đứt quan hệ vì cảm thấy bị áp đặt.": 0
        }
    },
    8: {
        "id": 8,
        ...
        "scores": {
            "Vẫn tận hưởng cuộc sống độc thân và chờ duyên đến.": 3,
            "Có chút mong muốn nhưng không để nó trở thành áp lực.": 2,
            "Cảm thấy lạc lõng và vội vàng tìm người yêu để không bị tụt lại.": 1,
            "Cho rằng mình kém cỏi vì vẫn còn độc thân.": 0
        }
    },
    9: {
        "id": 9,
        ...
        "scores": {
            "Cố gắng học hỏi và cải thiện kỹ năng của bản thân.": 3,
            "Tập trung vào điểm mạnh của mình thay vì so sánh.": 2,
            "Cảm thấy tự ti và nghĩ rằng mình không thể giỏi như họ.": 1,
            "Bỏ cuộc vì cho rằng mình không có năng khiếu.": 0
        }
    },
    10: {
        "id": 10,
        ...
        "scores": {
            "Chúc mừng họ và không để nó ảnh hưởng đến mình.": 3,
            "Lắng nghe nhưng không quá quan tâm.": 2,
            "Cảm thấy ghen tị và khó chịu.": 1,
            "Cắt đứt liên lạc với họ vì cảm thấy bị áp lực.": 0
        }
    }
}